...
conn = pymysql.connect(
    # host = 'localhost',
    host = para.DATABASE_URI,
    port = para.DATABASE_PORT,
    user = para.DATABASE_USER,
    passwd = para.DATABASE_PASSWD,
    db = para.DATABASE_NAME,
    charset = 'utf8'
)
cur = conn.cursor()
app = Flask(__name__)
...
# msg = Message('errInfo', sender='mgc5320@163.com', recipients=['1019233973@qq.com'])
